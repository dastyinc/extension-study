<script lang="ts">
    ...
    let showTodo = false, showStudyModal = false;
    ...
    <div style="display: flex;">
        <div style="margin-right: 1.375rem;">
            <Box background="#f8f8f8" style="width: 18.813rem; height: 19.438rem; padding: 1.25rem">
                ...
                <Timer bind:hours bind:minutes bind:seconds bind:play bind:status bind:time bind:time_id
        ...
        <div>
            <Box background="#28222d" style="width: 18.813rem; height: 15.938rem; padding: 1.25rem">
                ...
                <TodoList bind:todoList bind:goal bind:status AlterChecked={alterChecked} _AlterChecked={_alterChecked}
